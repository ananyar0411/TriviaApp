...
class TriviaTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.database_path = "postgresql://{}:{}@{}/{}".format('postgres', 'anniebebo47','localhost:5432', self.database_name)
    ...
    def test_get_question_search_without_results(self):
        res = self.client().post('/questions/search', json={'searchTerm': 'lalala'})
        data = json.loads(res.data)
    ...
    def test_get_question_search_by_categories_without_results(self):
